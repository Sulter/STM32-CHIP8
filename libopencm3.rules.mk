...
CPPFLAGS	+= -I$(INCLUDE_DIR) -I$(OUR_INCLUDE_DIR) $(DEFS)
...
clean:
	@#printf "  CLEAN\n"
	$(Q)$(RM) $(OUR_BUILD_DIR)/*.o $(OUR_BUILD_DIR)/*.d $(OUR_BUILD_DIR)/*.elf $(OUR_BUILD_DIR)/*.bin $(OUR_BUILD_DIR)/*.hex $(OUR_BUILD_DIR)/*.srec $(OUR_BUILD_DIR)/*.list $(OUR_BUILD_DIR)/*.map
